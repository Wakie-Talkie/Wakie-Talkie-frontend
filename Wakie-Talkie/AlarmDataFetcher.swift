...
class AlarmDataFetcher: ObservableObject {
    ...
    func fetchAlarms(){
        let fetchedAlarms = [
            Alarm(id: "alarm1", userId: "eunhwa813", time: transformToDate(dateString: "1:48 PM"), language: "ENGLISH", repeatDays: [false, false, false, false, false, false, false], isOn: true),
