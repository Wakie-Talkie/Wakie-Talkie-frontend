...
class AlarmDataFetcher: ObservableObject {
    ...
    func fetchAlarms(){
        let fetchedAlarms = [
            Alarm(id: "alarm1", userId: "eunhwa813", time: transformToDate(dateString: "8:34 PM"), language: "ENGLISH", repeatDays: [false, false, false, false, false, false, false], isOn: true),
            Alarm(id: "alarm2", userId: "eunhwa813", time: transformToDate(dateString: "8:00 AM"), language: "KOREAN", repeatDays: [false, true, false, true, false, false, false], isOn: true),
            Alarm(id: "alarm3", userId: "eunhwa813", time: transformToDate(dateString: "12:00 PM"), language: "JAPANESE", repeatDays: [false, true, false, false, false, true, false], isOn: false),
