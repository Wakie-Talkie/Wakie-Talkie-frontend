...
class AlarmDataFetcher: ObservableObject {
    @Published var alarms: [AlarmTemp]?
    ...
    func fetchAlarms(){
        let fetchedAlarms = [
            ...
            AlarmTemp(id: "alarm4", userId: "eunhwa813", time: transformToDate(dateString: "7:00 PM"), language: "FRENCH", repeatDays: [false, false, true, false, false, false, false], isOn: true),
            AlarmTemp(id: "alarm5", userId: "eunhwa813", time: transformToDate(dateString: "1:20 PM"), language: "CHINESE", repeatDays: [false, false, false, false, false, false, true], isOn: false)
        ]
