...
struct AlarmDummy: Identifiable, Codable {
    var id: String
    ...
    init(id: String = "", time: Date = Date(), language: String = "", repeatDays: [Bool] = [false, false, false, false, false, false, false], isOn: Bool = true, aiProfiles: [String]? = nil) {
        self.id = id
        self.time = time
