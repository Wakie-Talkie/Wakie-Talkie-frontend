...
struct AlarmCell: View {
    ...
    @Binding var alarmData: AlarmDummy
    var body: some View {
        ZStack{
...
struct AlarmCellTestView: View{
    @State var alarm: AlarmDummy = AlarmDummy(id: "alarm1", time: Date.now, language: "ENGLISH", repeatDays: [false, false, true, false, false, false, false], isOn: true)
    var body: some View{
