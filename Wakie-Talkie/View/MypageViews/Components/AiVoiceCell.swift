...
struct AiVoiceCellTextView: View{
    @State var aiProfile: AIProfile = AIProfile(id: "aiNo.1", nickname: "Alexis",profileImg: "ai_profile_me1", description: "like watching animation and go out for a walk.", language: "영어")
